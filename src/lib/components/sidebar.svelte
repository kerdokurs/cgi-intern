...
>
  <h1 class="text-2xl font-bold">Length of day calculator</h1>
  <h2 class="text-lg">Insert coordinates or choose a point from the map</h2>

  <div>
    <div class="text-left grid grid-cols-2 gap-2">
      <label for="start"> {showRange ? 'Start d' : 'D'}ate </label>
      <input
        type="date"
        name="start"
        id="start"
